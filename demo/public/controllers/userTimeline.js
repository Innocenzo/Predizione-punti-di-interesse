...
/** controller */
demo.controller('UserTimelineCtrl', function UserTimelineCtrl($scope, $location, UserTimeline, filterFilter, $routeParams ) {
        var userTimeline = $scope.userTimeline = UserTimeline.$query();
